...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i3 = K(r), l3 = h(), d2 = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u2 = C((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), p3 = "", f2 = "";
    i3.left + a2 + d2 > l3.width - O() ? i3.left < d2 ? e % 2 === 1 ? p3 = i3.left ? "-" + i3.left + "px" : "100%" : e % 2 === 0 && (p3 = l3.width - d2 - O() + "px") : p3 = "-100%" : p3 = "100%", t2.getBoundingClientRect().top + u2 + s4 > l3.height ? f2 = `-${s4 - u2}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = p3;
  }
}
function Qt() {
...
// node_modules/.pnpm/primeng@21.1.6_3dc8455f034b4170dd0602a69855ad24/node_modules/primeng/fesm2022/primeng-api.mjs
var _c0 = ["*"];
...
//# sourceMappingURL=chunk-6X4SBNEN.js.map
